...
#
# $Id: parser.rb,v 1.1 2001/01/25 22:36:51 michael Exp $
#


# every method have to check if the context is right
# just at the beginning.
# other methods can expect a special node-type and call
# a method which handles that, this method must raise an
# error if it isn't the expected type.
